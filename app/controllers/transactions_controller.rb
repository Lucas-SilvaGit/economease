...
class TransactionsController < ApplicationController
  ...
  def create
    ...
    unless valid_account?(@transaction.account)
      @transaction.errors.add(:account, I18n.t("transaction.errors.invalid"))
    ...
    if processor.process_transaction(:save!)
      redirect_to transactions_path, notice: I18n.t("transaction.notice.create")
    else
  ...
  def update
    ...
    if processor.process_transaction(:save!)
      redirect_to transactions_path, notice: I18n.t("transaction.notice.edit")
    else
  ...
  def destroy
    ...
    redirect_to transactions_url, notice: I18n.t("transaction.notice.destroy")
  end
